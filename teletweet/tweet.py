...
from config import CONSUMER_KEY, CONSUMER_SECRET, ACCESS_KEY, ACCESS_SECRET, TODAY_CONFIG, SIGN, SOURCE_CHANNEL, CHANNEL_URL
...
def send_tweet(message, pics: Union[list, None] = None) -> dict:
    ...
    text = TODAY_CONFIG + SOURCE_CHANNEL + f"{message.id}"
